...
class Hangman:
    ...
    def setup_alphabet_buttons(self):
        ...
        upper_row, lower_row = alphabet[:13], alphabet[13:]
    ...
    def draw_left_arm(self):
        self.hangman_canvas.create_line(155, 110, 125, 150, fill="black")
    ...
    def display_game_over_message(self, message):
        ...
        if not hasattr(self, 'reset_button'):
            self.reset_button = tk.Button(self.master, text="Restart Game", command=self.reset_game, width=20, height=2, bg="#4a7a8c", font=("Helvetica", 12, "bold"))
